...
void io_accelerometer_initialise(void)
{
    ...
    i2c1_tx_data(I2C_ADDRESS_ACCEL, I2C_TRANSMIT_REQUEST);
}
...
void io_accelerometer_read(int32_t *accel_x, int32_t *accel_y, int32_t *accel_z)
{
    ...
    i2c1_tx_data(I2C_ADDRESS_ACCEL, I2C_TRANSMIT_NORMAL);
    while(i2c1_transfer_in_progress() == true) {}
...
void io_magnetometer_initialise(void)
{
    ...
    i2c1_tx_data(I2C_ADDRESS_MAG, I2C_TRANSMIT_REQUEST);
}
...
void io_magnetometer_read(int32_t *mag_x, int32_t *mag_y, int32_t *mag_z)
{
    ...
    i2c1_tx_data(I2C_ADDRESS_MAG, I2C_TRANSMIT_NORMAL);
    while(i2c1_transfer_in_progress() == true) {}
...
{
    const static pin_t led[] = {LED_NW, LED_N, LED_NE, LED_E, LED_SE, LED_S, LED_SW, LED_W};
