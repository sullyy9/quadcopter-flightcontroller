...
#define GYRO_CTRL_REG_1_VAL     ( ( GYRO_DATA_RATE << 6 ) + ( GYRO_BANDWIDTH << 4 ) + \
                                  ( GYRO_POWER_ON  << 3 ) + ( GYRO_Z_AXIS_ON << 2 ) + \
...
#define GYRO_CTRL_REG_2_VAL     ( ( GCR1_UNUSED_1    << 7 ) + ( GCR1_UNUSED_2      << 6 ) + \
                                  ( GYRO_FILTER_MODE << 4 ) + ( GYRO_FILTER_CUTOFF << 0 ) )
...
#define GYRO_CTRL_REG_3_VAL     ( ( GYRO_INT1_ON         << 7 ) + ( GYRO_INT1_BOOT      << 6 ) + \
                                  ( GYRO_INT1_ACTIVE_L_H << 5 ) + ( GYRO_PP_OD          << 4 ) + \
                                  ( GYRO_INT2_DRDY       << 3 ) + ( GYRO_INT2_WATERMARK << 2 ) + \
                                  ( GYRO_INT2_OVERRUN    << 1 ) + ( GYRO_INT2_EMPTY     << 0 ) )
...
#define GYRO_CTRL_REG_4_VAL     ( ( GCR4_UNUSED_1  << 7 ) + ( GYRO_B_L_ENDIAN  << 6 ) + \
                                  ( GYRO_SCALE     << 4 ) + ( GCR4_UNUSED_2    << 3 ) + \
...
#define GYRO_CTRL_REG_5_VAL     ( ( GYRO_REBOOT_MEM << 7 ) + ( GYRO_FIFO_ON      << 6 ) + \
                                  ( GCR5_UNUSED_1   << 5 ) + ( GYRO_HP_FILTER_ON << 4 ) + \
                                  ( GYRO_INT1_MODE  << 2 ) + ( GYRO_OUT_MODE     << 0 ) )
